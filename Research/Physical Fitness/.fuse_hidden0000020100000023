...
By: Nicholas Nelson, Michael Rae, Peter Attia

May 30, 2026

![](https://peterattiamd.com/wp-content/uploads/2026/05/June2026_lowering-the-barrier-to-entry-for-resistance-training_HeaderImage-1200x400.png)[Exercise](https://peterattiamd.com/category/exercise/)
...
This study does not change what is _optimal_. But it does help define what is sufficient to obtain meaningful benefits when starting resistance training.
...
We’ll often focus on their group **LM2**, which stands for **L**ow load (<80% of 1RM), **M**ultiple sets, training **2** times per week. A standard optimum protocol would typically fall into the **HM3** category: **H**igh load (≥80% of 1RM), **M**ultiple sets, training in **3+** sessions weekly. Though less common, some athletic training protocols also follow an **HM2** structure (≥80% 1RM, multiple sets, 2 times weekly). Resistance training interventions needed to be conducted for ≥6 weeks for inclusion in the meta-analysis. 

Outcomes included changes in strength (measured by one-repetition maximum), hypertrophy (assessed via imaging-based measures of muscle size), and mobility (evaluated using functional tests such as Timed Up and Go and sit-to-stand performance). Outcomes were reported as _standardized mean difference_ (SMD), roughly equivalent to how many standard deviations a training intervention improved an outcome relative to no training—permitting the authors to pool and compare effects between different studies. 

One limitation worth noting is how “intensity” was defined. The analysis used _load,_ as a percentage of the participant’s 1RM, as a proxy for intensity. They did not standardize variables such as proximity to failure or reps in reserve—key variables in peak resistance training paradigms. While this lack of standardization introduces variability, it also reflects real-world training conditions: individuals follow a wide range of prescriptions, which rarely _begin_ training with strict control or attention to these levers.
...
![Molecular texture image](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10705-1024x581.jpg)

![Man biking](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10707-1024x581.jpg)

![Man running](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10707-1-1024x886.jpg)

![Pills texture image](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10708-1024x885.jpg)

![Woman doing a pull-up](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10709-1024x886.jpg)

![Molecular texture image](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10705-2-1024x581.jpg)

![Legs of a man jumping](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10707-3-1024x581.jpg)

![Man running](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10707-4-1024x886.jpg)

![](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10708-1-1024x885.jpg)

![Man looking upward with molecular structure in background](https://peterattiamd.com/wp-content/uploads/2025/08/Rectangle-10709-1-1024x886.jpg)
...
![](https://peterattiamd.com/wp-content/uploads/2026/05/image-1.png)

Figure 1: Strength improvements as a function of different training programs. The LM2 group shows an average improvement effect that is 77% the size of the training programs typically considered optimal—HM3 and HM2. Adapted from Currier et al. 2023,1 boxes added to emphasize programs of interest.

While this means that LM2 represents a meaningful reduction in strength gains compared to optimized protocols, these gains are still far from trivial. The _majority_ of the strength adaptation is maintained despite a _substantial_ reduction in training intensity and frequency.
...
![](https://peterattiamd.com/wp-content/uploads/2026/05/image-2.png)

Figure 2: Hypertrophy as a function of different training programs. The LM2 group is not statistically different from the more optimized training protocols. Adapted from Currier et al. 2023,1 boxes added to emphasize programs of interest.
...
This aligns with observations that moderate loads, typically corresponding to approximately 8–12 repetitions per set, are sufficient to stimulate meaningful muscle growth.2
...
![](https://peterattiamd.com/wp-content/uploads/2026/05/image.png)

Figure 3: Mobility as a function of different training programs. Programs with multiple sets per exercise per session are highlighted for emphasis. Adapted from Currier et al. 2023.1 
...
1. Currier BS, Mcleod JC, Banfield L, et al. Resistance training prescription for muscle strength and hypertrophy in healthy adults: a systematic review and Bayesian network meta-analysis. _Br J Sports Med_. 2023;57(18):1211-1220. doi:[10.1136/bjsports-2023-106807](https://dx.doi.org/10.1136/bjsports-2023-106807)

2. Schoenfeld BJ, Grgic J, Van Every DW, Plotkin DL. Loading recommendations for muscle strength, hypertrophy, and local endurance: A re-examination of the repetition continuum. _Sports (Basel)_. 2021;9(2):32. doi:[10.3390/sports9020032](https://dx.doi.org/10.3390/sports9020032)

3. Barry E, Galvin R, Keogh C, Horgan F, Fahey T. Is the Timed Up and Go test a useful predictor of risk of falls in community dwelling older adults: a systematic review and meta-analysis. _BMC Geriatr_. 2014;14(1):14. doi:[10.1186/1471-2318-14-14](https://dx.doi.org/10.1186/1471-2318-14-14)

4. Rikli RE, Jones CJ. Development and validation of criterion-referenced clinically relevant fitness standards for maintaining physical independence in later years. _Gerontologist_. 2013;53(2):255-267. doi:[10.1093/geront/gns071](https://dx.doi.org/10.1093/geront/gns071)