...
>
> **Scope**: spans `Communicable Diseases/` and its sub-folders — the CDC working group ([[CLAUDE-CDC]]), the Outbreak Management Reporting System ([[CLAUDE-OMRS]]), and the Connect Care CD Episode work. Governed by [[CLAUDE-Communicable-Diseases]].
>
