...
- **Source user stories** — [[Submit Facility Outbreak Line List - Facility Operator User Story]] (O-ET-1, the line-list instrument), [[Submit Aggregate Outbreak Report - Facility Operator User Story]] (O-M-1, the aggregate instrument), and [[Document Facility Outbreak Phone Encounter - PPHST Call Analyst User Story]] (the PPHST intake that may attach a completed instrument). Anchored by [[02 - Create Outbreak Investigation - CDC Investigator User Story]] (O-A-4) and [[Create Outbreak Investigation Screen Specifications]], from which this screen is launched.
