...
- **Data model** — [[OMRS Database ERD]] (v2.0, January 12, 2026), principally the `InfectiousDisease`, `OutbreakDefinition`, `Symptom` / `DiseaseSymptom`, `Organism` / `DiseaseOrganism`, and `VersionStatus` tables.
