...
3. **Activity timeline per outbreak.** Present a chronological timeline of all interactions and task completions for an outbreak so the investigation history is visible at a glance without reading the audit log — feeding the manager review in O-M-6 and the metrics view in [[10 - Manager Outbreak Metrics and Reporting - Team Lead Department Manager User Story|O-M-7]].
...
- **Manager task-list capability (O-M-6).** AC5/AC6 consume the task lists created in [[04 - Maintain Outbreak Task Lists - Team Lead Department Manager User Story]]; this story is the investigator-side counterpart. Keep the two aligned on the shared task model.
...
| Related Story                | [[04 - Maintain Outbreak Task Lists - Team Lead Department Manager User Story]] (O-M-6 — manager creates the task lists this story works); [[03 - Assign Staff to Outbreak - Team Lead Department Manager User Story]] (O-M-5 — team stood up); [[10 - Manager Outbreak Metrics and Reporting - Team Lead Department Manager User Story]] (O-M-7 — manager review/metrics); [[02 - Create Outbreak Investigation - CDC Investigator User Story]] (O-A-4) |
