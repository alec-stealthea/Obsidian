...
| Related Story                | [[03 - Assign Staff to Outbreak - Team Lead Department Manager User Story]] (O-M-5 — team stood up); [[Track Outbreak Activities and Tasks - CDC Investigator User Story]] (O-M-8 — investigator-side counterpart that works/tracks these task lists and shares the task data model); [[Submit Facility Outbreak Line List - Facility Operator User Story]] (O-ET-1 — line-list feed); [[02 - Create Outbreak Investigation - CDC Investigator User Story]] (O-A-4) |
