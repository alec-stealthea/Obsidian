...
_Version_: 1.2 (added the Manage (M) story O-M-6 — Maintain Outbreak Task Lists; recommended a new O-M-7 Manager Outbreak Metrics & Reporting story per Jessica's review comment)
