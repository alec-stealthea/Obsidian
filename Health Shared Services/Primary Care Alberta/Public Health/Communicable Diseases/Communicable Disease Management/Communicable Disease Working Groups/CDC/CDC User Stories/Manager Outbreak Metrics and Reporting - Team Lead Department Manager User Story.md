...
This is **cross-outbreak reporting and analytics**, which is why it is a separate story from the single-outbreak task work in O-M-6, and why it is the dedicated **manager outbreak-reporting** story already flagged as to-be-created in O-M-5. It is partially served today — [[Outbreak Search - Outbreak Investigator User Story]] (O-C-3) offers a filtered export across outbreaks, and [[Submit Aggregate Outbreak Report - Facility Operator User Story]] (O-M-1) covers aggregate *case* reporting — but neither provides a manager-facing **metrics/KPI** view over a group of outbreaks. That view is what this story specifies.
...
- **Single-outbreak task management.** Per-outbreak task lists and completion are O-M-6 ([[Maintain Outbreak Task Lists - Team Lead Department Manager User Story]]); this story measures across outbreaks, it does not manage tasks.
- **Aggregate case reporting by facility operators.** Symptom/absentee aggregate counts are O-M-1 ([[Submit Aggregate Outbreak Report - Facility Operator User Story]]); this story reports on *program/process* metrics (timeliness, KPI), not case aggregates.
- **The investigator-facing search/export.** Cross-outbreak search and filtered export for investigators is O-C-3 ([[Outbreak Search - Outbreak Investigator User Story]]); this story is the manager-facing *metrics* counterpart and may reuse that export plumbing.
...
- **Source stories.** Conceptual predecessors: [[Assign Staff to Outbreak - Team Lead Department Manager User Story]] (O-M-5, which first flagged this reporting story) and [[Maintain Outbreak Task Lists - Team Lead Department Manager User Story]] (O-M-6, whose review raised it).
...
| Related Story                | [[Assign Staff to Outbreak - Team Lead Department Manager User Story]] (O-M-5 — flagged this story); [[Maintain Outbreak Task Lists - Team Lead Department Manager User Story]] (O-M-6 — review raised it); [[Outbreak Search - Outbreak Investigator User Story]] (O-C-3 — investigator export); [[Submit Aggregate Outbreak Report - Facility Operator User Story]] (O-M-1) |
