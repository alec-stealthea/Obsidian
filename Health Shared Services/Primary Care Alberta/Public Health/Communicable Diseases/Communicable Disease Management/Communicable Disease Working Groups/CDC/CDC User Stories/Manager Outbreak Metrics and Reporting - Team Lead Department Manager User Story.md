...
- **Source stories.** Conceptual predecessors: [[03 - Assign Staff to Outbreak - Team Lead Department Manager User Story]] (O-M-5, which first flagged this reporting story) and [[Maintain Outbreak Task Lists - Team Lead Department Manager User Story]] (O-M-6, whose review raised it).
