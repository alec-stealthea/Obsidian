...
description: "Inferred triples are those triples that derive from an inference rule rather than those that come from a priori assertions from external sources."
