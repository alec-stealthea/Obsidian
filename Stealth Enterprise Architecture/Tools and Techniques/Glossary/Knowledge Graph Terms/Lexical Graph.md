...
• **Edges** capture lexical or semantic connections—like synonyms, antonyms, hypernyms (broader terms), hyponyms (more specific terms), and other relationships found in resources such as [WordNet](https://wordnet.princeton.edu/).